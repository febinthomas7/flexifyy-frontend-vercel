...
const MovieDetails = () => {
  ...
  return (
    <div className="w-full h-screen bg-[#000000f4] overflow-hidden flex flex-col gap-4  items-center justify-center  bg-no-repeat bg-center overflow-y-auto p-6 relative bg-[url('/bgImage.svg')]">
      <Helmet>
